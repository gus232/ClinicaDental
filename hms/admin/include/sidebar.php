                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="Manage-doctors.php">
                                <span class="title"> Gestionar Doctores </span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="read-query.php">
                                <span class="title"> Consulta Leída </span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="doctor-logs.php">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title"> Registros de Sesiones de Doctor </span>
                            </div>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="user-logs.php">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title"> Registros de Sesiones de Usuario </span>
                            </div>
                        </div>
                    </a>
                </li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="between-dates-reports.php">
                                <span class="title"> Reportes Entre Fechas </span>
                            </a>
                        </li>
                    </ul>
                </li>
