...
<html lang="es">
<head>
    <title>Admin | Registros de Sesiones de Usuarios</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin  | Registros de Sesiones de Usuarios</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li><span>Admin </span></li>
                                <li class="active"><span>Registros de Sesiones de Usuarios</span></li>
                            </ol>
                        </div>
                    </section>
