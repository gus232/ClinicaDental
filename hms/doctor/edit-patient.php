...
if($sql)
{
echo "<script>alert('Información del paciente actualizada exitosamente');</script>";
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Ingrese el historial médico del paciente (si lo hay)" required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>   
<div class="form-group">
<label for="fess">
 Fecha de Creación
