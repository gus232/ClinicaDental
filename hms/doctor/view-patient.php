...
if(isset($_POST['submit']))
{
    ...
    if ($query) {
        echo '<script>alert("Historial médico agregado.")</script>';
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table border="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        <th scope>Número de Teléfono del Paciente</th>
                                    ...
                                    <tr>
                                        <th>Historial Médico del Paciente (si hay)</th>
                                                ...
                                                <table class="table table-bordered table-hover data-tables">
                                                    <form method="post" name="submit">
                                                        <tr>
                                                            <th>Presión Arterial :</th>
                                                            <td>
                                                                <input name="bp" placeholder="Presión Arterial" class="form-control wd-450" required="true">
                                                            </td>
                                                        </tr>                          
                                                        <tr>
                                                            <th>Azúcar en Sangre :</th>
                                                            <td>
                                                                <input name="bs" placeholder="Azúcar en Sangre" class="form-control wd-450" required="true">
                                                            </td>
                                                        </tr> 
                                                        <tr>
                                                            <th>Peso :</th>
                                                            <td>
                                                                <input name="weight" placeholder="Peso" class="form-control wd-450" required="true">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Temperatura Corporal :</th>
                                                            <td>
                                                                <input name="temp" placeholder="Temperatura Corporal" class="form-control wd-450" required="true">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Prescripción :</th>
                                                            <td>
                                                                <textarea name="pres" placeholder="Prescripción Médica" rows="12" cols="14" class="form-control wd-450" required="true"></textarea>
                                                            </td>
                                                        </tr>  
                                                </table>
                                            </div>
