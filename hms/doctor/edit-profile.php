            ...
            <div class="app-content">
                ...
                <div class="main-content">
                    <div class="wrap-content container" id="container">
                        ...
                        <!-- end: TÍTULO DE LA PÁGINA -->
                        <!-- start: EJEMPLO BÁSICO -->
...
<p><b>Última Fecha de Actualización del Perfil: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
<hr />
...
<div class="form-group">
                                                            <label for="fess">
                                                                 Honorarios de Consulta del Médico
                                                            </label>
