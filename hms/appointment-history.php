...
<head>
    ...
    <style>
        /* Mejoras visuales para historial de citas */
        .mainTitle {
            font-size: 32px;
            font-weight: 700;
            color: #2c3e50;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if(($row['userStatus']==0) && ($row['doctorStatus']==1)) {
                                                echo '<span class="status-badge status-cancelled-user"><i class="fa fa-times-circle"></i> Cancelada por Ti</span>';
                                            }
                                            if(($row['userStatus']==1) && ($row['doctorStatus']==0)) {
                                                echo '<span class="status-badge status-cancelled-doctor"><i class="fa fa-ban"></i> Cancelada por el Doctor</span>';
                                            }
                                            ?>
                                        </td>
                                        <td>
