...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2025 at 06:29 PM
...
(1, 'min_length', '8', 'Longitud mínima de contraseña', '2025-10-21 00:20:33', NULL),
...
INSERT INTO `permissions` (`id`, `permission_name`, `display_name`, `description`, `module`, `category_id`, `is_system_permission`, `created_at`) VALUES
(1, 'view_users', 'Ver Usuarios', 'Permite ver la lista de usuarios del sistema', 'users', 1, 1, '2025-10-21 11:40:15'),
(2, 'create_user', 'Crear Usuario', 'Permite registrar nuevos usuarios', 'users', 1, 1, '2025-10-21 11:40:15'),
(3, 'edit_user', 'Editar Usuario', 'Permite modificar información de usuarios', 'users', 1, 1, '2025-10-21 11:40:15'),
(4, 'delete_user', 'Eliminar Usuario', 'Permite dar de baja usuarios', 'users', 1, 1, '2025-10-21 11:40:15'),
(5, 'manage_user_roles', 'Gestionar Roles de Usuario', 'Permite asignar/revocar roles a usuarios', 'users', 1, 1, '2025-10-21 11:40:15'),
(6, 'unlock_accounts', 'Desbloquear Cuentas', 'Permite desbloquear cuentas bloqueadas', 'users', 1, 1, '2025-10-21 11:40:15'),
(7, 'reset_passwords', 'Resetear Contraseñas', 'Permite resetear contraseñas de otros usuarios', 'users', 1, 1, '2025-10-21 11:40:15'),
(8, 'view_user_activity', 'Ver Actividad de Usuarios', 'Permite ver logs de actividad de usuarios', 'users', 1, 1, '2025-10-21 11:40:15'),
(9, 'view_patients', 'Ver Pacientes', 'Permite ver la lista de pacientes', 'patients', 2, 1, '2025-10-21 11:40:15'),
(10, 'view_patient_details', 'Ver Detalles de Paciente', 'Permite ver información detallada de pacientes', 'patients', 2, 1, '2025-10-21 11:40:15'),
(11, 'create_patient', 'Registrar Paciente', 'Permite registrar nuevos pacientes', 'patients', 2, 1, '2025-10-21 11:40:15'),
(12, 'edit_patient', 'Editar Paciente', 'Permite modificar información de pacientes', 'patients', 2, 1, '2025-10-21 11:40:15'),
(13, 'delete_patient', 'Eliminar Paciente', 'Permite dar de baja pacientes', 'patients', 2, 1, '2025-10-21 11:40:15'),
(14, 'view_own_patient_data', 'Ver Mis Datos', 'Permite al paciente ver su propia información', 'patients', 2, 1, '2025-10-21 11:40:15'),
(15, 'export_patient_data', 'Exportar Datos de Pacientes', 'Permite exportar información de pacientes', 'patients', 2, 1, '2025-10-21 11:40:15'),
(16, 'view_doctors', 'Ver Doctores', 'Permite ver la lista de doctores', 'doctors', 3, 1, '2025-10-21 11:40:15'),
(17, 'create_doctor', 'Registrar Doctor', 'Permite registrar nuevos doctores', 'doctors', 3, 1, '2025-10-21 11:40:15'),
(18, 'edit_doctor', 'Editar Doctor', 'Permite modificar información de doctores', 'doctors', 3, 1, '2025-10-21 11:40:15'),
(19, 'delete_doctor', 'Eliminar Doctor', 'Permite dar de baja doctores', 'doctors', 3, 1, '2025-10-21 11:40:15'),
(20, 'manage_doctor_schedule', 'Gestionar Horarios de Doctor', 'Permite configurar horarios de doctores', 'doctors', 3, 1, '2025-10-21 11:40:15'),
(21, 'view_doctor_performance', 'Ver Rendimiento de Doctores', 'Permite ver estadísticas de doctores', 'doctors', 3, 1, '2025-10-21 11:40:15'),
(22, 'view_appointments', 'Ver Citas', 'Permite ver todas las citas', 'appointments', 4, 1, '2025-10-21 11:40:15'),
(23, 'view_own_appointments', 'Ver Mis Citas', 'Permite ver solo sus propias citas', 'appointments', 4, 1, '2025-10-21 11:40:15'),
(24, 'create_appointment', 'Crear Cita', 'Permite agendar nuevas citas', 'appointments', 4, 1, '2025-10-21 11:40:15'),
(25, 'edit_appointment', 'Editar Cita', 'Permite modificar citas existentes', 'appointments', 4, 1, '2025-10-21 11:40:15'),
(26, 'cancel_appointment', 'Cancelar Cita', 'Permite cancelar citas', 'appointments', 4, 1, '2025-10-21 11:40:15'),
(27, 'approve_appointment', 'Aprobar Cita', 'Permite aprobar/rechazar citas', 'appointments', 4, 1, '2025-10-21 11:40:15'),
(28, 'reschedule_appointment', 'Reprogramar Cita', 'Permite cambiar fecha/hora de citas', 'appointments', 4, 1, '2025-10-21 11:40:15'),
(29, 'view_medical_records', 'Ver Registros Médicos', 'Permite ver historiales médicos', 'medical_records', 5, 1, '2025-10-21 11:40:15'),
(30, 'view_own_medical_records', 'Ver Mi Historial Médico', 'Permite ver solo su propio historial', 'medical_records', 5, 1, '2025-10-21 11:40:15'),
(31, 'create_medical_record', 'Crear Registro Médico', 'Permite crear nuevas entradas médicas', 'medical_records', 5, 1, '2025-10-21 11:40:15'),
(32, 'edit_medical_record', 'Editar Registro Médico', 'Permite modificar registros médicos', 'medical_records', 5, 1, '2025-10-21 11:40:15'),
(33, 'delete_medical_record', 'Eliminar Registro Médico', 'Permite eliminar registros médicos', 'medical_records', 5, 1, '2025-10-21 11:40:15'),
(34, 'view_prescriptions', 'Ver Recetas', 'Permite ver recetas médicas', 'medical_records', 5, 1, '2025-10-21 11:40:15'),
(35, 'create_prescription', 'Crear Receta', 'Permite generar recetas médicas', 'medical_records', 5, 1, '2025-10-21 11:40:15'),
(36, 'view_invoices', 'Ver Facturas', 'Permite ver facturas', 'billing', 6, 1, '2025-10-21 11:40:15'),
(37, 'view_own_invoices', 'Ver Mis Facturas', 'Permite ver solo sus propias facturas', 'billing', 6, 1, '2025-10-21 11:40:15'),
(38, 'create_invoice', 'Crear Factura', 'Permite generar nuevas facturas', 'billing', 6, 1, '2025-10-21 11:40:15'),
(39, 'edit_invoice', 'Editar Factura', 'Permite modificar facturas', 'billing', 6, 1, '2025-10-21 11:40:15'),
(40, 'delete_invoice', 'Eliminar Factura', 'Permite eliminar facturas', 'billing', 6, 1, '2025-10-21 11:40:15'),
(41, 'process_payment', 'Procesar Pagos', 'Permite registrar pagos', 'billing', 6, 1, '2025-10-21 11:40:15'),
(42, 'view_payment_reports', 'Ver Reportes de Pagos', 'Permite ver reportes financieros', 'billing', 6, 1, '2025-10-21 11:40:15'),
(43, 'view_reports', 'Ver Reportes', 'Permite ver reportes generales', 'reports', 7, 1, '2025-10-21 11:40:15'),
(44, 'create_report', 'Crear Reporte', 'Permite generar nuevos reportes', 'reports', 7, 1, '2025-10-21 11:40:15'),
(45, 'export_reports', 'Exportar Reportes', 'Permite exportar reportes a PDF/Excel', 'reports', 7, 1, '2025-10-21 11:40:15'),
(46, 'view_analytics', 'Ver Analíticas', 'Permite ver dashboards analíticos', 'reports', 7, 1, '2025-10-21 11:40:15'),
(47, 'view_audit_logs', 'Ver Logs de Auditoría', 'Permite ver registros de auditoría', 'reports', 7, 1, '2025-10-21 11:40:15'),
(48, 'manage_roles', 'Gestionar Roles', 'Permite crear/editar/eliminar roles', 'system', 8, 1, '2025-10-21 11:40:15'),
(49, 'manage_permissions', 'Gestionar Permisos', 'Permite asignar permisos a roles', 'system', 8, 1, '2025-10-21 11:40:15'),
(50, 'manage_system_settings', 'Gestionar Configuración', 'Permite modificar configuración del sistema', 'system', 8, 1, '2025-10-21 11:40:15'),
(51, 'manage_password_policies', 'Gestionar Políticas de Contraseña', 'Permite configurar políticas de seguridad', 'system', 8, 1, '2025-10-21 11:40:15'),
(52, 'view_system_logs', 'Ver Logs del Sistema', 'Permite ver logs técnicos', 'system', 8, 1, '2025-10-21 11:40:15'),
(53, 'backup_database', 'Respaldar Base de Datos', 'Permite crear backups', 'system', 8, 1, '2025-10-21 11:40:15'),
(54, 'restore_database', 'Restaurar Base de Datos', 'Permite restaurar desde backups', 'system', 8, 1, '2025-10-21 11:40:15'),
(55, 'view_security_logs', 'Ver Logs de Seguridad', 'Permite ver intentos de login y eventos de seguridad', 'security', 9, 1, '2025-10-21 11:40:15'),
(56, 'manage_security_settings', 'Gestionar Seguridad', 'Permite configurar opciones de seguridad', 'security', 9, 1, '2025-10-21 11:40:15'),
(57, 'view_failed_logins', 'Ver Intentos Fallidos', 'Permite ver intentos de login fallidos', 'security', 9, 1, '2025-10-21 11:40:15'),
(58, 'manage_session_timeout', 'Gestionar Timeouts', 'Permite configurar tiempos de sesión', 'security', 9, 1, '2025-10-21 11:40:15');
...
INSERT INTO `permission_categories` (`id`, `category_name`, `display_name`, `description`, `icon`, `sort_order`) VALUES
(1, 'users', 'Gestión de Usuarios', 'Permisos relacionados con la administración de usuarios', 'fa-users', 1),
(2, 'patients', 'Gestión de Pacientes', 'Permisos para manejo de pacientes', 'fa-wheelchair', 2),
(3, 'doctors', 'Gestión de Doctores', 'Permisos para manejo de doctores', 'fa-user-md', 3),
(4, 'appointments', 'Gestión de Citas', 'Permisos para manejo de citas médicas', 'fa-calendar', 4),
(5, 'medical_records', 'Registros Médicos', 'Permisos para historiales médicos', 'fa-file-text-o', 5),
(6, 'billing', 'Facturación', 'Permisos para manejo de facturación', 'fa-usd', 6),
(7, 'reports', 'Reportes', 'Permisos para generación de reportes', 'fa-bar-chart', 7),
(8, 'system', 'Configuración del Sistema', 'Permisos de administración del sistema', 'fa-cogs', 8),
(9, 'security', 'Seguridad', 'Permisos de auditoría y seguridad', 'fa-shield', 9);
...
(1, 'admin', 'Administrador', 'Acceso casi total al sistema sin restricciones', 1, 1, 'active', '2025-10-21 11:40:15', '2025-10-23 22:23:20', NULL),
...
(8, 'auditor', 'Auditor 1', 'Audita el modulo ABM ', 0, 15, 'inactive', '2025-10-22 22:26:42', '2025-10-23 00:06:44', NULL),
(10, 'auditor_u', 'Auditor 1', 'Auditar ABM', 0, 50, 'active', '2025-10-23 00:59:21', '2025-10-23 01:41:39', NULL);
...
(158, 4, 26, '2025-10-21 11:40:16', NULL),
(159, 4, 24, '2025-10-21 11:40:16', NULL),
(160, 4, 16, '2025-10-21 11:40:16', NULL),
(404, 2, 57, '2025-10-24 00:56:32', 8),
(405, 2, 55, '2025-10-24 00:56:32', 8),
(406, 2, 51, '2025-10-24 00:56:32', 8),
(407, 2, 49, '2025-10-24 00:56:32', 8),
(408, 2, 48, '2025-10-24 00:56:32', 8),
(409, 2, 52, '2025-10-24 00:56:32', 8),
(410, 2, 2, '2025-10-24 00:56:32', 8),
(411, 2, 4, '2025-10-24 00:56:32', 8),
(412, 2, 3, '2025-10-24 00:56:32', 8),
(413, 2, 5, '2025-10-24 00:56:32', 8),
(414, 2, 7, '2025-10-24 00:56:32', 8),
(415, 2, 6, '2025-10-24 00:56:32', 8),
(416, 2, 8, '2025-10-24 00:56:32', 8),
(417, 2, 1, '2025-10-24 00:56:32', 8),
(467, 1, 17, '2025-10-24 03:37:10', 8),
(468, 1, 19, '2025-10-24 03:37:10', 8),
(469, 1, 18, '2025-10-24 03:37:10', 8),
(470, 1, 20, '2025-10-24 03:37:10', 8),
(471, 1, 21, '2025-10-24 03:37:10', 8),
(472, 1, 16, '2025-10-24 03:37:10', 8),
(473, 1, 56, '2025-10-24 03:37:10', 8),
(474, 1, 58, '2025-10-24 03:37:10', 8),
(475, 1, 57, '2025-10-24 03:37:10', 8),
(476, 1, 55, '2025-10-24 03:37:10', 8),
(477, 1, 53, '2025-10-24 03:37:10', 8),
(478, 1, 51, '2025-10-24 03:37:10', 8),
(479, 1, 49, '2025-10-24 03:37:10', 8),
(480, 1, 48, '2025-10-24 03:37:10', 8),
(481, 1, 50, '2025-10-24 03:37:10', 8),
(482, 1, 54, '2025-10-24 03:37:10', 8),
(483, 1, 52, '2025-10-24 03:37:10', 8),
(484, 1, 2, '2025-10-24 03:37:10', 8),
(485, 1, 4, '2025-10-24 03:37:10', 8),
(486, 1, 3, '2025-10-24 03:37:10', 8),
(487, 1, 5, '2025-10-24 03:37:10', 8),
(488, 1, 7, '2025-10-24 03:37:10', 8),
(489, 1, 6, '2025-10-24 03:37:10', 8),
(490, 1, 8, '2025-10-24 03:37:10', 8),
(491, 1, 1, '2025-10-24 03:37:10', 8);
...
(8, 'willy.z@clinica.muelitas.com', '$2y$12$xpRZx/B1nX.nHu9uV0eY6ecbfxFDfbJhibXgKsW9xtoWcbk4Za7m.', 'admin', 'Willy Perez Marco', 'active', '2025-10-21 00:57:55', '2025-10-24 01:49:03', '2025-10-24 01:49:03', 0, NULL, '2026-01-18 20:57:55', '2025-10-20 20:57:55', '::1', 0),
...
(25, 'juan.t@clinica.muelitas.com', '$2y$10$1bj.m68c2pFWtXie1tvonOR7dAJwlgK5NiGe2q7WMoZeinJIFeUHG', 'patient', 'Juan Andres Torrez', 'active', '2025-10-24 00:48:37', '2025-10-24 00:48:37', NULL, 0, NULL, NULL, NULL, NULL, 0),
...
(29, 'carlos.m@clinica.muelitas.com', '$2y$10$iQ1/PtzCFJJjwUr/P5AywOMZOSp8nQCFJwGktK6lxeaJCUFw2Bu.i', 'doctor', 'Carlos Molina Vázquez', 'active', '2025-10-24 01:52:23', '2025-10-24 01:52:23', NULL, 0, NULL, NULL, NULL, NULL, 0),
...
(27, 30, 1, '2025-10-24 03:31:03', 8, NULL, 1);
