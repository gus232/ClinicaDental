-- ============================================================================
-- INSTALADOR DE STORED PROCEDURES - FASE 3
-- ============================================================================
...
BEGIN
    ...
    ELSE
        INSERT INTO users (
            full_name, address, city, gender, email, password, contactno,
            reg_date, updation_date, status
        ) VALUES (
            p_full_name, p_address, p_city, p_gender, p_email, p_password, p_contactno,
            NOW(), NOW(), 1
        );
