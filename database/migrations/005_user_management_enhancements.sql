...
-- Permite auditoría y trazabilidad de todas las modificaciones
-- ============================================================================

CREATE TABLE IF NOT EXISTS user_change_history (
    id INT PRIMARY KEY AUTO_INCREMENT,
    user_id INT NOT NULL COMMENT 'Usuario que fue modificado',
    changed_by INT NULL COMMENT 'Usuario que realizó el cambio',
...
CREATE TABLE IF NOT EXISTS user_notes (
    ...
    created_by INT NULL COMMENT 'Admin que creó la nota',
